...
def merge_to_video(audio_path: str, 
    ...
    try:
        ...
        if srt_path:
            ...
            filter_complex.append(f'[videotmp]subtitles={srt_path}:force_style=\'FontName=SimHei,FontSize=30,PrimaryColour=&H00FFFF,OutlineColour=&H000000,BorderStyle=1,Outline=2,MarginV=30\'[video]')
